...
public class DragPhotoView extends PhotoView {
    ...
    private void onActionUp(MotionEvent event) {
        ...
        if (mTranslateY > MAX_TRANSLATE_Y) {
            if (mExitListener != null) {
                mExitListener.onExit(this, mTranslateX, mTranslateY, mWidth, mHeight, mScale);
            } else {
    ...
    public interface OnExitListener {
        void onExit(DragPhotoView view, float translateX, float translateY, float w, float h, float scale);
    }
    ...
    public void finishAnimationCallBack() {
        ...
        Log.e("TAG", "mTranslateX:" + mTranslateX + "    mScale：" + mScale);
        invalidate();
    }
}
